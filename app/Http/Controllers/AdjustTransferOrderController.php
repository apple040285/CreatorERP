...
use App\Exports\AdjustTransferOrdersExport;
...
class AdjustTransferOrderController extends Controller
{
    /**
    ...
    public function show(Request $request, $id)
    {
        ...
        try {
            $data = AdjustOrder::findOrFail($id);

            $data->load('items.product', 'items.storehouse', 'creator', 'editor');
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            $record = AdjustOrder::findOrFail($id);
    ...
    public function destroy(Request $request, $id)
    {
        ...
        try {
            DB::beginTransaction();
            $data = AdjustOrder::findOrFail($id)->delete();
    ...
    {
        return Excel::download(new AdjustTransferOrdersExport($request->all()), '調撥.xls', \Maatwebsite\Excel\Excel::XLS);
    }
}
