...
<div class="d-flex justify-content-around align-items-center">
    ...
    <a class="d-block my-2 btn btn-md btn-primary btnBlock" href="/">銷售清單</a>
</div>
<div class="d-flex justify-content-around align-items-center">
    <a class="d-block my-2 btn btn-md btn-primary btnBlock" href="/">商品退貨</a>
    <a class="d-block my-2 btn btn-md btn-primary btnBlock" href="/">退貨清單</a>
</div>
<div class="d-flex justify-content-around align-items-center">
    <a class="d-block my-2 btn btn-md btn-primary btnBlock" href="/">調撥作業</a>
    <a class="d-block my-2 btn btn-md btn-primary btnBlock" href="/">盤點作業</a>
</div>
<div class="d-flex justify-content-around align-items-center">
