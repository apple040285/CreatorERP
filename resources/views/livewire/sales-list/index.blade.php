                ...
                <tbody>
                    @foreach ($this->orders as $order)
                        <tr>
                            ...
                            <td>
                                <button type="button" wire:click="$set('order_id', '{{ $order->id }}')" class="p-0 d-flex justify-content-start align-items-start btn btn-link w-100" data-toggle="modal" data-target="#detailModal">
                            ...
                            <td class="text-center">
                                <button type="button" wire:click="$set('order_id', '{{ $order->id }}')" class="p-0 btn btn3Link text-mblue1 d-block mx-auto" data-toggle="modal" data-target="#actionModal">
                ...
                <div class="modal-body cgy3 f14">
                    ...
                    @if ($order_id)
                        <div class="show3LinkModal f16">
                            <button type="button" wire:click="viewOrder" class="my-4 p-0 btn text-mblue1 w-100">
                                檢視
                            </button>
