<div>
    ...
    <div class="topTxt text-center mb-4">
        <div class="f20 fw800">客戶名稱：{{ $this->orderItem->order->customer_manufacturer?->full_name }}</div>
    </div>
    ...
    <form wire:submit.prevent="next" class="form-group">
        ...
        <div class="f16 w-75 my-3 d-block mx-auto">
            ...
            <input type="text" class="form-control" placeholder="單價" readonly value="{{ $this->orderItem->product?->price }}">
        </div>
        ...
        <div class="f16 w-75 my-3 d-block mx-auto">
            ...
            <input type="text" class="form-control" placeholder="國際條碼" readonly value="{{ $this->orderItem->product?->barcode }}">
        </div>
