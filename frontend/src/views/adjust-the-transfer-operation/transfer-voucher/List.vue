            ...
            <b-card-code :title="$t('Transfer Voucher')">
                ...
                <div class="custom-search d-md-flex justify-content-between">
                    <div class="d-flex">
                        ...
                        <!-- Excel 匯出 -->
                        <ExcelExportAction
                          name="adjust-transfer-orders"
                          import-url="/adjust-transfer-orders/import"
                          export-url="/adjust-transfer-orders/export"
                          :params="serverParams"
                        />
                    </div>
                    <div class="d-flex">
                ...
                <!-- table -->
                    ...
                    >
                        <span class="text-nowrap" v-if="props.column.label !== '#'">
                            {{$t('TransferVoucherList.' + props.column.label) }}
                        </span>
                    </template>
                    <template
                        slot="table-row"
                        ...
                        <span v-else-if="props.column.field === 'action'" class="text-nowrap">
                            <span>
                                <b-button
                                    ...
                                    variant="outline-primary"
                                    size="sm"
                                    :to="{ name: 'AdjustTheTransferOperation-TransferVoucherDetail', query: { id: props.row.id } }"
                                    class="mr-1"
                                >
                                    <feather-icon
                                        icon="FilePlusIcon"
                                ...
                                <b-button
                                    ...
                                    :to="{ name: 'AdjustTheTransferOperation-TransferVoucherEdit', query: { id: props.row.id } }"
                                >
                                    <feather-icon
                                        icon="Edit2Icon"
                                    />
