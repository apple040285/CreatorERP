<template>
    <div>
        <b-row>
            <b-col cols="12">
                <b-card-code :title="$t('Bank Data Setting')">
                    ...
                    <div class="custom-search d-flex justify-content-end">
                        <b-button
                            ...
                            class="mb-2 mr-2"
                            :to="{ name: 'BasicData-BankDataSettingCreate' }"
                        >
                            {{ $t('create')}}
                        </b-button>
                        <b-form-group>
                            ...
                            <span v-else-if="props.column.field === 'action'" class="text-nowrap">
                                <span>
                                    <b-button
                                        ...
                                        variant="outline-primary"
                                        size="sm"
                                        :to="{ name: 'BasicData-BankDataSettingDetail', query: { id: props.row.id } }"
                                        class="mr-1"
                                    >
                                        <feather-icon
                                            icon="FilePlusIcon"
                                    ...
                                    <b-button
                                        ...
                                        size="sm"
                                        class="mr-50"
                                        :to="{ name: 'BasicData-BankDataSettingEdit', query: { id: props.row.id } }"
                                    >
                                        <feather-icon
                                            icon="Edit2Icon"
                                            class="mr-25"
