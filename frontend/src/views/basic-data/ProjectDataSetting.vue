<template>
    <div>
        <b-row>
            <b-col cols="12">
                <b-card-code :title="$t('Project Data Setting')">
                    ...
                    >
                        ...
                        >
                            <span class="text-nowrap" v-if="props.column.label !== '#'">
                                {{ $t('ProjectList.' + props.column.label) }}
                            </span>
                        </template>
                        <template
                            slot="table-row"
        ...
        >
            <b-form @submit.prevent>
                <validation-observer ref="modalRules">
                    <b-form-group id="projectCode">
                        <label for="code">{{ $t('ProjectList.code') }}</label>
                        <validation-provider
                            #default="{ errors }"
                            name="projectCode"
                            rules="required"
                    ...
                    <b-form-group id="projectName">
                        <label for="name">{{ $t('ProjectList.name') }}</label>
                        <validation-provider
                            #default="{ errors }"
                            name="projectName"
                            rules="required"
                    ...
                    <b-form-group
                        label-for="expiration_date-datepicker"
                        id="expiration_date"
                    >
        ...
        updateMethod() {
            ...
            .then(() => {
                ...
                this.$toast({
                    ...
                    icon: 'CoffeeIcon',
                    variant: 'success',
                    text: `${this.$t('Project Data Setting')} ${this.$t('updatedSuccess')}!`,
                    },
                })
            })
            .catch(error => {
        ...
        createMethod() {
            ...
            .then(() => {
                ...
                this.$toast({
                    ...
                    icon: 'CoffeeIcon',
                    variant: 'success',
                    text: `${this.$t('Project Data Setting')} ${this.$t('createdSuccess')}!`,
                    },
                })
            })
            .catch(error => {
