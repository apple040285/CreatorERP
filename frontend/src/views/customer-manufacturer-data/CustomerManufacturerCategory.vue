<template>
    <div>
        <b-row>
            <b-col cols="12">
                <b-card-code :title="$t('Customer/Manufacturer Category')">
                    ...
                    >
                        ...
                        >
                            <span class="text-nowrap" v-if="props.column.label !== '#'">
                                {{ $t('CustomManufacturerCategoryList.' + props.column.label) }}
                            </span>
                        </template>
                        <template
                            slot="table-row"
        ...
        >
            <b-form @submit.prevent>
                <validation-observer ref="modalRules">
                    <b-form-group id="customManufacturerCategoryCode">
                        <label for="code">{{ $t('CustomManufacturerCategoryList.code') }}</label>
                        <validation-provider
                            #default="{ errors }"
                            name="customManufacturerCategoryCode"
                            rules="required"
                        >
                            <b-form-input
                    ...
                    <b-form-group id="customManufacturerCategoryName">
                        <label for="name">{{ $t('CustomManufacturerCategoryList.name') }}</label>
                        <validation-provider
                            #default="{ errors }"
                            name="customManufacturerCategoryName"
                            rules="required"
                        >
                            <b-form-input
                    ...
                    <b-form-group id="category">
                        <label for="category">{{ $t('CustomManufacturerCategoryList.category') }}</label>
                        <validation-provider
                            #default="{ errors }"
                            name="CustomManufacturerCategory"
                            rules="required"
                        >
                            <v-select
        ...
        updateMethod() {
            ...
            .then(() => {
                ...
                this.$toast({
                    ...
                    icon: 'CoffeeIcon',
                    variant: 'success',
                    text: `${this.$t('Customer/Manufacturer Category')} ${this.$t('updatedSuccess')}!`,
                    },
                })
            })
            .catch(error => {
        ...
        createMethod() {
            ...
            .then(() => {
                ...
                this.$toast({
                    ...
                    icon: 'CoffeeIcon',
                    variant: 'success',
                    text: `${this.$t('Customer/Manufacturer Category')} ${this.$t('createdSuccess')}!`,
                    },
                })
            })
            .catch(error => {
                ...
                if (result.value) {
                    ...
                    .then(() => {
                        ...
                        this.$toast({
                            ...
                            icon: 'CoffeeIcon',
                            variant: 'success',
                            text: `${this.$t('Customer/Manufacturer Category')} ${this.$t('deletedSuccess')}!`,
                            },
                        })
                    })
                    .catch(error => {
