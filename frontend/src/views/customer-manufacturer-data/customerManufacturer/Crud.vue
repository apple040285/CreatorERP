      ...
      <b-form @submit.prevent>
        <validation-observer ref="simpleRules">
          <b-row>
            ...
            <b-col cols="4">
              <b-form-group
                id="customerManufacturerCode"
                label-for="code"
              >
                <template #label>
                  {{ $t('CustomerManufacturerList.code') }}
            ...
            <b-col cols="4">
              <b-form-group
                id="customerManufacturerFullName"
                label-for="full_name"
              >
                <template #label>
                  {{ $t('CustomerManufacturerList.fullName') }}
                  <span class="text-danger">*</span>
                </template>
          ...
          <b-row>
            ...
            <b-col cols="4">
              <b-form-group
                label-for="type"
                id="customerManufacturerBelong"
              >
                <template #label>
                  {{ $t('CustomerManufacturerList.belong') }}
                  <span class="text-danger">*</span>
                </template>
            ...
            <b-col cols="4">
              <b-form-group
                id="customerManufacturerCategory"
                label-for="customerManufacturerCategory"
              >
                <template #label>
                  {{ $t('CustomerManufacturerList.category') }}
                  <span class="text-danger">*</span>
                </template>
          ...
          <b-row>
            ...
            <b-col cols="4">
              ...
              >
                <template #label>
                  {{ $t('CustomerManufacturerList.currency') }}
                  <span class="text-danger">*</span>
                </template>
            ...
            <b-col cols="4">
              <b-form-group
                id="customerManufacturerTaxDeductionCategory"
                label-for="customerManufacturerTaxDeductionCategory"
              >
                <template #label>
                  {{ $t('CustomerManufacturerList.taxDeductionCategory') }}
                  <span class="text-danger">*</span>
                </template>
          ...
          <b-row>
            ...
            <b-col cols="4">
              <b-form-group
                id="customerManufacturerAccountSettingMethod"
                label-for="customerManufacturerAccountSettingMethod"
              >
                <template #label>
                  {{ $t('CustomerManufacturerList.accountSettingMethod') }}
                  <span class="text-danger">*</span>
                </template>
