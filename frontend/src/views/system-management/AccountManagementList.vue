<template>
    <div>
        <b-row>
            <b-col cols="12">
                <b-card-code :title="$t('Account Management')">
                    ...
                    <div class="custom-search d-flex justify-content-end">
                        <b-button
                            ...
                            class="mb-2 mr-2"
                            :to="{ name: 'SystemManagement-AccountManagementCreate' }"
                        >
                            {{ $t('create')}}
                        </b-button>
                        <b-form-group>
                            ...
                            <span v-else-if="props.column.field === 'action'" class="text-nowrap">
                                <span>
                                    <b-button
                                        ...
                                        size="sm"
                                        class="mr-50"
                                        :to="{ name: 'SystemManagement-AccountManagementEdit', query: { id: props.row.id } }"
                                    >
                                        <feather-icon
                                            icon="Edit2Icon"
                                            class="mr-25"
