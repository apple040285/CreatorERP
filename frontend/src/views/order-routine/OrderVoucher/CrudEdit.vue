      ...
      <validation-observer ref="simpleRules">
        ...
        >
          ...
          <b-row>
            ...
            <!-- 客戶 -->
            <b-form-group
              :label="$t('OrderVoucherList.customer')"
              label-for="customer"
              class="col-12 col-sm-4"
            >
              <validation-provider
              ...
              >
                <v-select
                  ...
                  :placeholder="$t('OrdernVoucherModel.quotationCustomer')"
             ...
             <!-- 幣別 -->
             <b-form-group
              :label="$t('OrderVoucherList.currency')"
              label-for="currency"
              class="col-12 col-sm-4"
            >
              <validation-provider
              ...
              >
                <v-select
                  ...
                  :placeholder="$t('OrdernVoucherModel.selectCurrency')"
                  :reduce="option => option.id"
                />
                <small class="text-danger">{{ errors[0] }}</small>
              </validation-provider>
            ...
            <!-- 轉入單號 -->
            <b-form-group
              :label="$t('OrderVoucherList.transferNo')"
            ...
            >
              ...
              >
                <v-select
                  ...
                  :placeholder="$t('OrdernVoucherModel.selectTransferNo')"
                  :reduce="option => option.id"
                />
                <small class="text-danger">{{ errors[0] }}</small>
              </validation-provider>
            ...
            <!-- 業務人員 -->
            <b-form-group
              :label="$t('OrderVoucherList.businessPeople')"
            ...
            >
              ...
              >
                <v-select
                  ...
                  :options="staffOption"
                  :placeholder="$t('OrdernVoucherModel.businessPeople')"
                  :reduce="option => option.id"
                />
                <small class="text-danger">{{ errors[0] }}</small>
              </validation-provider>
            ...
            <!-- 部門 -->
            <b-form-group
              :label="$t('OrderVoucherList.quotationdepartment')"
            ...
            >
              ...
              >
                <v-select
                  ...
                  :placeholder="$t('OrdernVoucherModel.quotationdepartment')"
                  :reduce="option => option.id"
                />
                <small class="text-danger">{{ errors[0] }}</small>
              </validation-provider>
            ...
            <!-- 扣稅類別 -->
            <b-form-group
              :label="$t('OrderVoucherList.taxDeductionCategory')"
            ...
            >
              ...
              >
                <v-select
                  ...
                  :placeholder="$t('OrderVoucherList.selectTaxDeductionCategory')"
            ...
            <!-- 客戶訂單 -->
            <b-form-group
              :label="$t('OrderVoucherList.customerReservation')"
            ...
            <!-- 未稅本幣 -->
            <b-form-group
              :label="$t('OrderVoucherList.untaxedLocalCurrency')"
            ...
            <!-- 本幣稅額 -->
            <b-form-group
              :label="$t('OrderVoucherList.localCurrencyTax')"
            ...
            <!-- 本幣合計 -->
            <b-form-group
              :label="$t('OrderVoucherList.totalLocalCurrency')"
        ...
        <b-card
          v-if="showData"
          :title="$t('OrdernVoucherModel.productInformation')"
        >
          <b-button
            variant="primary"
            type="button"
          ...
          >
            <b-thead>
              <b-tr>
                ...
                <b-th class="text-nowrap"> {{$t('OrderVoucherList.ProductList.productNo') }} </b-th>
                <b-th class="text-nowrap"> {{$t('OrderVoucherList.ProductList.productName') }} </b-th>
                <b-th class="text-nowrap"> {{$t('OrderVoucherList.ProductList.specification') }} </b-th>
                <b-th class="text-nowrap"> {{$t('OrderVoucherList.ProductList.unit') }} </b-th>
                <b-th class="text-nowrap"> {{$t('OrderVoucherList.ProductList.storehouse') }} </b-th>
                <b-th class="text-nowrap"> {{$t('OrderVoucherList.ProductList.quantity') }} </b-th>
                <b-th class="text-nowrap"> {{$t('OrderVoucherList.ProductList.unitPrice') }} </b-th>
                <b-th class="text-nowrap"> {{$t('OrderVoucherList.ProductList.amount') }} </b-th>
                <b-th class="text-nowrap"> {{$t('OrderVoucherList.ProductList.numberOfTransfers') }} </b-th>
                <b-th class="text-nowrap"> {{$t('OrderVoucherList.ProductList.untransferredQuantity') }} </b-th>
                <b-th class="text-nowrap"> {{$t('OrderVoucherList.ProductList.productRemark') }} </b-th>
                <b-th class="text-nowrap"> {{$t('OrderVoucherList.ProductList.action') }} </b-th>
              </b-tr>
            </b-thead>
              ...
              >
                ...
                <b-td>
                  ...
                  >
                    <v-select
                      ...
                      :placeholder="$t('OrdernVoucherModel.selectProductName')"
                      :filterable="false"
                      style="width: 300px;"
                ...
                <b-td>
                  <v-select
                    ...
                    :placeholder="$t('OrdernVoucherModel.selectStorehouse')"
                    :reduce="option => option.id"
                    class="text-nowrap"
                    style="width: 120px;"
                  />
                ...
                <b-td>
                  ...
                  >
                    <b-form-input
                      ...
                      min="0"
                      :placeholder="$t('OrderVoucherList.ProductList.quantity')"
                    />
                    <small class="text-danger">{{ errors[0] }}</small>
                  </validation-provider>
                </b-td>
                ...
                <b-td>
                  ...
                  >
                    <b-form-input
                      ...
                      min="0"
                      :placeholder="$t('OrderVoucherList.ProductList.unitPrice')"
                    />
                    <small class="text-danger">{{ errors[0] }}</small>
                  </validation-provider>
                </b-td>
