  ...
  <div>
    <b-form @submit.prevent>
      <validation-observer ref="simpleRules">
        ...
        <b-card
          v-if="showData"
          :title="showData.id ? $t('SubscriberVoucherModel.editSubscriberVoucher') : $t('SubscriberVoucherModel.createSubscriberVoucher')"
        >
          <b-row>
            <!-- 訂購日期 -->
            <b-form-group
              label-for="subscriberDate"
              class="col-12 col-sm-4"
            >
              <template #label>
                {{ $t('SubscriberVoucherList.subscriberDate') }}
              ...
              >
                <flat-pickr
                  id="subscriberDate"
                  v-model="showData.subscriber_date"
                  :placeholder="$t('SubscriberVoucherList.subscriberDate')"
                  class="form-control"
                />
            ...
            <!-- 訂購單號 -->
            <b-form-group
              label-for="subscriber_no"
              class="col-12 col-sm-4"
            >
              <template #label>
                {{ $t('SubscriberVoucherList.subscriberNo') }}
              ...
              <b-form-input
                id="subscriberNo"
                type="text"
                :placeholder="$t('SubscriberVoucherList.subscriberNo')"
                disabled
                :value="showData.subscriber_order_no"
              />
            </b-form-group>
            ...
            >
              <template #label>
                {{ $t('SubscriberVoucherList.transferNo') }}
              </template>
              ...
              >
                <v-select
                  ...
                  :placeholder="$t('SubscriberVoucherModel.selectTransferNo')"
            ...
            >
              <template #label>
                {{ $t('SubscriberVoucherList.customer') }}
                <span class="text-danger">*</span>
              </template>
              ...
              >
                <v-select
                  ...
                  :placeholder="$t('SubscriberVoucherModel.selectCustomer')"
                  :reduce="option => option.id"
                />
                <small class="text-danger">{{ errors[0] }}</small>
              </validation-provider>
            ...
            <!-- 業務人員 -->
            <b-form-group
              label-for="subscriberStaff"
              class="col-12 col-sm-4"
            >
              <template #label>
                {{ $t('SubscriberVoucherList.subscriberStaff') }}
                <span class="text-danger">*</span>
              </template>

              <validation-provider
                #default="{ errors }"
                name="subscriberStaff"
              >
                <v-select
                  id="subscriberStaff"
                  label="name"
                  ...
                  :options="staffOption"
                  :placeholder="$t('SubscriberVoucherModel.selectSubscriberStaff')"
                  :reduce="option => option.id"
                />
                <small class="text-danger">{{ errors[0] }}</small>
              </validation-provider>
            ...
            <!-- 訂購部門 -->
            <b-form-group
              label-for="subscriberDepartment"
              class="col-12 col-sm-4"
            >
              <template #label>
                {{ $t('SubscriberVoucherList.subscriberDepartment') }}
                <span class="text-danger">*</span>
              </template>
              ...
              >
                <v-select
                  id="subscriberDepartment"
                  label="name"
                  v-model="showData.department_id"
                  :options="subscriberDepartmentOption"
                  :placeholder="$t('SubscriberVoucherModel.selectSubscriberDepartment')"
                  :reduce="option => option.id"
                />
                <small class="text-danger">{{ errors[0] }}</small>
              </validation-provider>
           ...
           <b-form-group
            ...
            >
              <template #label>
                {{ $t('SubscriberVoucherList.preDeliveryDate') }}
              </template>
              ...
              >
                <flat-pickr
                  ...
                  :placeholder="$t('SubscriberVoucherList.preDeliveryDate')"
                  class="form-control"
                />
                <small class="text-danger">{{ errors[0] }}</small>
              </validation-provider>
            ...
            >
              <template #label>
                {{ $t('SubscriberVoucherList.project') }}
              </template>
              ...
              >
                <v-select
                  ...
                  :placeholder="$t('SubscriberVoucherModel.selectProject')"
                  :reduce="option => option.id"
                />
                <small class="text-danger">{{ errors[0] }}</small>
              </validation-provider>
            ...
            >
              <template #label>
                {{ $t('SubscriberVoucherList.taxDeductionCategory') }}
                <span class="text-danger">*</span>
              </template>
              ...
              >
                <v-select
                  ...
                  :placeholder="$t('SubscriberVoucherList.selectTaxDeductionCategory')"
            ...
            >
              <template #label>
                {{ $t('SubscriberVoucherList.currency') }}
                <span class="text-danger">*</span>
              </template>
              ...
              >
                <v-select
                  ...
                  :placeholder="$t('SubscriberVoucherModel.selectCurrency')"
                  :reduce="option => option.id"
                />
                <small class="text-danger">{{ errors[0] }}</small>
              </validation-provider>
        ...
        <b-card
          v-if="showData"
          :title="$t('SubscriberVoucherModel.productInformation')"
        >
          <b-button
            variant="primary"
            type="button"
          ...
          >
            <b-thead>
              <b-tr>
                ...
                <b-th class="text-nowrap"> {{ $t('SubscriberVoucherList.ProductList.productNo') }} </b-th>
                <b-th class="text-nowrap"> {{ $t('SubscriberVoucherList.ProductList.productName') }} </b-th>
                <b-th class="text-nowrap"> {{ $t('SubscriberVoucherList.ProductList.specification') }} </b-th>
                <b-th class="text-nowrap"> {{ $t('SubscriberVoucherList.ProductList.unit') }} </b-th>
                <b-th class="text-nowrap"> {{ $t('SubscriberVoucherList.ProductList.storehouse') }} </b-th>
                <b-th class="text-nowrap"> {{ $t('SubscriberVoucherList.ProductList.quantity') }} </b-th>
                <b-th class="text-nowrap"> {{ $t('SubscriberVoucherList.ProductList.unitPrice') }} </b-th>
                <b-th class="text-nowrap"> {{ $t('SubscriberVoucherList.ProductList.amount') }} </b-th>
                <b-th class="text-nowrap"> {{ $t('SubscriberVoucherList.ProductList.productPreDeliveryDate') }} </b-th>
                <b-th class="text-nowrap"> {{ $t('SubscriberVoucherList.ProductList.productRemark') }} </b-th>
                <b-th class="text-nowrap"> {{ $t('SubscriberVoucherList.ProductList.action') }} </b-th>
              </b-tr>
            </b-thead>
              ...
              >
                ...
                <b-td>
                  <v-select
                    ...
                    :placeholder="$t('SubscriberVoucherModel.selectProductName')"
                    :filterable="false"
                    style="width: 200px;"
                ...
                <b-td>
                  <v-select
                    ...
                    :placeholder="$t('SubscriberVoucherModel.selectStorehouse')"
                    :reduce="option => option.id"
                    class="text-nowrap"
                    style="width: 130px;"
                  />
                ...
                <b-td>
                  ...
                  >
                    <b-form-input
                      ...
                      min="0"
                      :placeholder="$t('SubscriberVoucherList.ProductList.quantity')"
                    />
                    <small class="text-danger">{{ errors[0] }}</small>
                  </validation-provider>
                </b-td>
                ...
                <b-td>
                  ...
                  >
                    <b-form-input
                      ...
                      v-model="item.price"
                      min="0"
                      :placeholder="$t('SubscriberVoucherList.ProductList.unitPrice')"
                    />
                    <small class="text-danger">{{ errors[0] }}</small>
                  </validation-provider>
                </b-td>
        ...
        <div class="d-sm-flex align-items-center justify-content-center">
          <b-button
            ...
            :to="{ name: 'OrderRoutine-SubscriberVoucherList' }"
          >
            <feather-icon
              icon="ArrowLeftIcon"
              class="mr-50"
...
export default {
  ...
  setup(_, { root, refs }) {
    ...
    // 讀取
    if (root.$route.name === 'OrderRoutine-SubscriberVoucherCreate') {
      showData.value = {
        items: [],
      }
    } else {
              ...
              .then(() => {
                root.$toast({
                  ...
                  props: {
                    ...
                    icon: 'CoffeeIcon',
                    variant: 'success',
                    text: `${root.$t('Subscriber Voucher')} ${root.$t('updatedSuccess')}!`,
                  },
                })
                root.$router.push({ name: 'OrderRoutine-SubscriberVoucherList' });
              })
              .catch(error => {
                root.$toast({
                  component: ToastificationContent,
              ...
              .then(() => {
                root.$toast({
                  ...
                  props: {
                    ...
                    icon: 'CoffeeIcon',
                    variant: 'success',
                    text: `${root.$t('Subscriber Voucher')} ${root.$t('createdSuccess')}!`,
                  },
                })
                root.$router.push({ name: 'OrderRoutine-SubscriberVoucherList' });
              })
    ...
    // 部門
    const subscriberDepartmentOption = ref([])
    axios.post('/departments/options')
      .then(response => {
        subscriberDepartmentOption.value = response.data
      })
