      ...
      <template #cell(action)="data">
        <span class="text-nowrap">
          <b-button
            ...
            size="sm"
            class="mr-50"
            :to="{ name: 'PurchaseOperation-PurchaseVoucherEdit', query: { id: data.row.id } }"
          >
            <feather-icon
              icon="Edit2Icon"
              class="mr-25"
...
export default {
  ...
  setup(_, { root }) {
    ...
    const tableColumns = [
      { label: '#', field: 'id' },
      { label: 'PurchaseVoucherList.purchaseDate', field: 'purchaseDate' },
      { label: 'PurchaseVoucherList.purchaseNo', field: 'purchaseNo' },
      { label: 'PurchaseVoucherList.manufacturer', field: 'manufacturer' },
      { label: 'PurchaseVoucherList.purchaseStaff', field: 'purchaseStaff' },
      { label: 'PurchaseVoucherList.invoice', field: 'invoice' },
      { label: 'PurchaseVoucherList.preDeliveryDate', field: 'preDeliveryDate' },
      { label: 'PurchaseVoucherList.project', field: 'project' },
