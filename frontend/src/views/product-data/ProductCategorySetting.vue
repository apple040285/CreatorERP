<template>
    <div>
        <b-row>
            <b-col cols="12">
                <b-card-code :title="$t('Product Category Setting')">
                    ...
                    >
                        ...
                        >
                            <span class="text-nowrap" v-if="props.column.label !== '#'">
                                {{ $t('ProductCategoryList.' + props.column.label) }}
                            </span>
                        </template>
                        <template
                            slot="table-row"
        ...
        >
            <b-form @submit.prevent>
                <validation-observer ref="modalRules">
                    <b-form-group id="productCategoryCode">
                        <label for="code">{{ $t('ProductCategoryList.code') }}</label>
                        <validation-provider
                            #default="{ errors }"
                    ...
                    <b-form-group id="productCategoryName">
                        <label for="name">{{ $t('ProductCategoryList.name') }}</label>
                        <validation-provider
                            #default="{ errors }"
        ...
        updateMethod() {
            ...
            .then(() => {
                ...
                this.$toast({
                    ...
                    icon: 'CoffeeIcon',
                    variant: 'success',
                    text: `${this.$t('Product Category Setting')} ${this.$t('updatedSuccess')}!`,
                    },
                })
            })
            .catch(error => {
        ...
        createMethod() {
            ...
            .then(() => {
                ...
                this.$toast({
                    ...
                    icon: 'CoffeeIcon',
                    variant: 'success',
                    text: `${this.$t('Product Category Setting')} ${this.$t('createdSuccess')}!`,
                    },
                })
            })
            .catch(error => {
                ...
                if (result.value) {
                    ...
                    .then(() => {
                        ...
                        this.$toast({
                            ...
                            icon: 'CoffeeIcon',
                            variant: 'success',
                            text: `${this.$t('Product Category Setting')} ${this.$t('deletedSuccess')}!`,
                            },
                        })
                    })
                    .catch(error => {
