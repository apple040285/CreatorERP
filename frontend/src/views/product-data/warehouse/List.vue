<template>
    <div>
        <b-row>
            <b-col cols="12">
                <b-card-code :title="$t('Warehouse Data Setting')">
                    ...
                    <div class="custom-search d-flex justify-content-end">
                        ...
                        <ExcelAction
                          name="storehouses"
                          import-url="/storehouses/import"
                          export-url="/storehouses/export"
                        />
                        ...
                        <b-button
                            ...
                            class="mb-2 mr-2"
                            :to="{ name: 'ProductData-WarehouseDataSettingCreate' }"
                        >
                            {{ $t('create')}}
                        </b-button>
                        <b-form-group>
                    ...
                    >
                        ...
                        >
                            <span class="text-nowrap" v-if="props.column.label !== '#'">
                                {{ $t('WarehouseList.' + props.column.label) }}
                            </span>
                        </template>
                        <template
                            slot="table-row"
                            ...
                            <span v-else-if="props.column.field === 'action'" class="text-nowrap">
                                <span>
                                    <b-button
                                        ...
                                        variant="outline-primary"
                                        size="sm"
                                        :to="{ name: 'ProductData-WarehouseDataSettingDetail', query: { id: props.row.id } }"
                                        class="mr-1"
                                    >
                                        <feather-icon
                                            icon="FilePlusIcon"
                                    ...
                                    <b-button
                                        ...
                                        size="sm"
                                        class="mr-50"
                                        :to="{ name: 'ProductData-WarehouseDataSettingEdit', query: { id: props.row.id } }"
                                    >
                                        <feather-icon
                                            icon="Edit2Icon"
                                            class="mr-25"
                ...
                if (result.value) {
                    ...
                    .then(() => {
                        ...
                        this.$toast({
                            ...
                            icon: 'CoffeeIcon',
                            variant: 'success',
                            text: `${this.$t('Warehouse Data Setting')} ${this.$t('deletedSuccess')}!`,
                            },
                        })
                    })
                    .catch(error => {
