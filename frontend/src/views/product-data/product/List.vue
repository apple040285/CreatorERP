<template>
    <div>
        <b-row>
            <b-col cols="12">
                <b-card-code :title="$t('Product Data Setting')">
                    ...
                    <div class="custom-search d-flex justify-content-end">
                        <b-button
                            ...
                            class="mb-2 mr-2"
                            :to="{ name: 'ProductData-ProductDataSettingCreate' }"
                        >
                            {{ $t('create')}}
                        </b-button>
                        <b-form-group>
                            ...
                            <span v-else-if="props.column.field === 'action'" class="text-nowrap">
                                <span>
                                    <b-button
                                        ...
                                        variant="outline-primary"
                                        size="sm"
                                        :to="{ name: 'ProductData-ProductDataSettingDetail', query: { id: props.row.id } }"
                                        class="mr-1"
                                    >
                                        <feather-icon
                                            icon="FilePlusIcon"
                                    ...
                                    <b-button
                                        ...
                                        size="sm"
                                        class="mr-50"
                                        :to="{ name: 'ProductData-ProductDataSettingEdit', query: { id: props.row.id } }"
                                    >
                                        <feather-icon
                                            icon="Edit2Icon"
                                            class="mr-25"
                ...
                if (result.value) {
                    ...
                    .then(() => {
                        ...
                        this.$toast({
                            ...
                            icon: 'CoffeeIcon',
                            variant: 'success',
                            text: `${this.$t('Product Data Setting')} ${this.$t('deletedSuccess')}!`,
                            },
                        })
                    })
                    .catch(error => {
