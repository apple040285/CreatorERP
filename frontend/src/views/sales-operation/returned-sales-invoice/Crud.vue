<template>
    <div>
        <b-card-code :title="$route.name == 'SalesOperation-ReturnedSalesInvoiceCreate' ?  $t('ReturnedSalesInvoiceModal.createReturnedSalesInvoice') : $t('ReturnedSalesInvoiceModal.editReturnedSalesInvoice')">
                    ...
                    <b-row>
                        ...
                        <b-col cols="4">
                            <b-form-group
                                ...
                                id="returnedDate"
                            >
                                <label for="returnedDate">{{ $t('ReturnedSalesInvoiceList.returnedDate') }}</label>
                                <validation-provider
                                    #default="{ errors }"
                                    name="returnedDate"
                                    rules="required"
                        ...
                        <b-col cols="4">
                            <b-form-group>
                                <label for="customer">{{ $t('ReturnedSalesInvoiceList.customer') }}</label>
                                <validation-provider
                                    #default="{ errors }"
                                    name="customer"
                                    rules="required"
                                >
                                    <v-select
                                        ...
                                        :placeholder="$t('ReturnedSalesInvoiceModal.selectCustomer')"
                        ...
                        <b-col cols="4">
                            <b-form-group>
                                <label for="originalSalesNo">{{ $t('ReturnedSalesInvoiceList.originalSalesNo') }}</label>
                                <v-select
                                    label="name"
                                    v-model="showData.originalSalesNo_id"
                                    :options="originalSalesNoOption"
                                    :placeholder="$t('ReturnedSalesInvoiceModal.selectOriginalSalesNo')"
                                    :reduce="option => option.id"
                                />
                            </b-form-group>
                        </b-col>
                    ...
                    <b-row>
                        ...
                        <b-col cols="4">
                            <b-form-group id="businessPeople">
                                <label for="businessPeople">{{ $t('ReturnedSalesInvoiceList.businessPeople') }}</label>
                                <validation-provider
                                    #default="{ errors }"
                                    name="businessPeople"
                                    rules="required"
                                >
                                    <v-select
                                        ...
                                        :options="staffOption"
                                        :placeholder="$t('ReturnedSalesInvoiceModal.selectBusinessPeople')"
                                        :reduce="option => option.id"
                                    />
                                    <small class="text-danger">{{ errors[0] }}</small>
                                </validation-provider>
                        ...
                        <b-col cols="4">
                            <b-form-group id="department">
                                <label for="department">{{ $t('ReturnedSalesInvoiceList.department') }}</label>
                                <validation-provider
                                    #default="{ errors }"
                                    name="department"
                                    rules="required"
                                >
                                    <v-select
                                        ...
                                        :placeholder="$t('ReturnedSalesInvoiceModal.selectDepartment')"
                                        :reduce="option => option.id"
                                    />
                                    <small class="text-danger">{{ errors[0] }}</small>
                                </validation-provider>
                        ...
                        <b-col cols="4">
                            <b-form-group id="taxDeductionCategory">
                                <label for="taxDeductionCategory">{{ $t('ReturnedSalesInvoiceList.taxDeductionCategory') }}</label>
                                <validation-provider
                                    #default="{ errors }"
                                ...
                                >
                                    <v-select
                                        ...
                                        :placeholder="$t('ReturnedSalesInvoiceList.selectTaxDeductionCategory')"
                                        :reduce="option => option.value"
                                    >
                                        <template v-slot:option="{ label }">
                                        {{ $t('ReturnedSalesInvoiceList.'+label) }}
                                        </template>
                    ...
                    <b-row>
                        ...
                        <b-col cols="4">
                            <b-form-group id="accountSettingMethod">
                                <label for="accountSettingMethod">{{ $t('ReturnedSalesInvoiceList.accountSettingMethod') }}</label>
                                <validation-provider
                                    #default="{ errors }"
                                ...
                                >
                                    <v-select
                                        ...
                                        :placeholder="$t('ReturnedSalesInvoiceList.selectAccountSettingMethod')"
                                        :reduce="option => option.value"
                                    >
                                        <template v-slot:option="{ label }">
                                        {{ $t('ReturnedSalesInvoiceList.'+label) }}
                        ...
                        <b-col cols="4">
                            <b-form-group id="currency">
                                <label for="currency">{{ $t('ReturnedSalesInvoiceList.currency') }}</label>
                                <validation-provider
                                    #default="{ errors }"
                                    name="currency"
                                    rules="required"
                                >
                                    <v-select
                                        ...
                                        :placeholder="$t('ReturnedSalesInvoiceModal.selectCurrency')"
                                        :reduce="option => option.id"
                                    />
                                    <small class="text-danger">{{ errors[0] }}</small>
                                </validation-provider>
                        ...
                        <b-col cols="4">
                            <b-form-group>
                                <label for="project">{{ $t('ReturnedSalesInvoiceList.project') }}</label>
                                <v-select
                                    label="name"
                                    v-model="showData.project_id"
                                    :options="projectOption"
                                    :placeholder="$t('ReturnedSalesInvoiceModal.selectProject')"
                                    :reduce="option => option.id"
                                />
                            </b-form-group>
                        </b-col>
                    ...
                    <b-row>
                        ...
                        <b-col cols="4">
                            <b-form-group id="untaxedAmount">
                                <label for="untaxedAmount">{{ $t('ReturnedSalesInvoiceList.untaxedAmount') }}</label>
                                <b-form-input
                                    v-model="showData.untaxedAmount"
                                    type="text"
                                    readonly
                                    :placeholder="$t('ReturnedSalesInvoiceList.untaxedAmount')"
                                />
                            </b-form-group>
                        </b-col>
                        <!-- tax -->
                        <b-col cols="4">
                            <b-form-group id="tax">
                                <label for="tax">{{ $t('ReturnedSalesInvoiceList.tax') }}</label>
                                <b-form-input
                                    v-model="showData.tax"
                                    type="text"
                                    readonly
                                    :placeholder="$t('ReturnedSalesInvoiceList.tax')"
                                />
                            </b-form-group>
                        </b-col>
                        <!-- total -->
                        <b-col cols="4">
                            <b-form-group id="total">
                                <label for="total">{{ $t('ReturnedSalesInvoiceList.total') }}</label>
                                <b-form-input
                    ...
                    <b-row>
                        ...
                        <b-col cols="4">
                            <b-form-group id="totalLocalCurrency">
                                <label for="totalLocalCurrency">{{ $t('ReturnedSalesInvoiceList.totalLocalCurrency') }}</label>
                                <b-form-input
                                    v-model="showData.totalLocalCurrency"
                                    type="text"
                                    readonly
                                    :placeholder="$t('ReturnedSalesInvoiceList.totalLocalCurrency')"
                                />
                            </b-form-group>
                        </b-col>
                        <!--  Remark -->
            ...
            <div class="demo-spacing-0">
                ...
                >
                    <div class="alert-body">
                        <span>{{ $t('ReturnedSalesInvoiceList.ProductList.productDataCheck') }}</span>
                    </div>
                </b-alert>
                <b-row>
                    <!-- submit -->
                    ...
                    <b-col>
                        <b-button
                            ...
                            type="button"
                            variant="secondary"
                            :to="{ name: 'SalesOperation-ReturnedSalesInvoiceList' }"
                        >
                            {{ $t('back') }}
                        </b-button>
                    </b-col>
        ...
        >
            <b-form @submit.prevent>
                <validation-observer ref="modalRules">
                    <b-form-group>
                        <label for="productName">{{ $t('ReturnedSalesInvoiceList.ProductList.productName') }}</label>
                        <validation-provider
                            #default="{ errors }"
                            name="productName"
                            rules="required"
                        >
                            <v-select
                                ...
                                :placeholder="$t('ReturnedSalesInvoiceModal.selectProductName')"
                                id="productName"
                            />
                            <small class="text-danger">{{ errors[0] }}</small>
                        </validation-provider>
                    ...
                    <b-form-group>
                        <label for="productNo">{{ $t('ReturnedSalesInvoiceList.ProductList.productNo') }}</label>
                        <b-form-input
                            v-model="productsData.productNo"
                            type="text"
                            :placeholder="$t('ReturnedSalesInvoiceList.ProductList.productNo')"
                            readonly
                        />
                    </b-form-group>
                    <b-form-group>
                        <label for="specification">{{ $t('ReturnedSalesInvoiceList.ProductList.specification') }}</label>
                        <b-form-input
                            v-model="productsData.specification"
                            type="text"
                            :placeholder="$t('ReturnedSalesInvoiceList.ProductList.specification')"
                            readonly
                        />
                    </b-form-group>
                    <b-form-group>
                        <label for="unit">{{ $t('ReturnedSalesInvoiceList.ProductList.unit') }}</label>
                        <b-form-input
                            v-model="productsData.unit"
                            type="text"
                            :placeholder="$t('ReturnedSalesInvoiceList.ProductList.unit')"
                            readonly
                        />
                    </b-form-group>
                    <b-form-group>
                        <label for="storehouse">{{ $t('ReturnedSalesInvoiceList.ProductList.storehouse') }}</label>
                        <v-select
                            v-model="productsData.storehouse"
                            :options="storehouseOption"
                            :placeholder="$t('ReturnedSalesInvoiceModal.selectStorehouse')"
                        />
                    </b-form-group>
                    <b-form-group id="quantity">
                        <label for="quantity">{{ $t('ReturnedSalesInvoiceList.ProductList.quantity') }}</label>
                        <validation-provider
                            #default="{ errors }"
                            name="quantity"
                            rules="required"
                        >
                            <b-form-input
                                ...
                                :placeholder="$t('ReturnedSalesInvoiceList.ProductList.quantity')"
                            />
                            <small class="text-danger">{{ errors[0] }}</small>
                        </validation-provider>
                    </b-form-group>
                    <b-form-group id="unitPrice">
                        <label for="unitPrice">{{ $t('ReturnedSalesInvoiceList.ProductList.unitPrice') }}</label>
                        <validation-provider
                            #default="{ errors }"
                            name="unitPrice"
                            rules="required"
                        >
                            <b-form-input
                                ...
                                min="0"
                                :state="errors.length > 0 ? false:null"
                                :placeholder="$t('ReturnedSalesInvoiceList.ProductList.unitPrice')"
                            />
                            <small class="text-danger">{{ errors[0] }}</small>
                        </validation-provider>
                    </b-form-group>
                    <b-form-group id="untaxedAmount">
                        <label for="untaxedAmount">{{ $t('ReturnedSalesInvoiceList.ProductList.untaxedAmount') }}</label>
                        <validation-provider
                            #default="{ errors }"
                            name="untaxedAmount"
                            rules="required"
                        >
                            <b-form-input
                                ...
                                min="0"
                                :state="errors.length > 0 ? false:null"
                                :placeholder="$t('ReturnedSalesInvoiceList.ProductList.untaxedAmount')"
                            />
                            <small class="text-danger">{{ errors[0] }}</small>
                        </validation-provider>
                    </b-form-group>
                    <b-form-group id="tax">
                        <label for="tax">{{ $t('ReturnedSalesInvoiceList.ProductList.tax') }}</label>
                        <validation-provider
                            #default="{ errors }"
                            name="tax"
                            rules="required"
                        >
                            <b-form-input
                                ...
                                min="0"
                                :state="errors.length > 0 ? false:null"
                                :placeholder="$t('ReturnedSalesInvoiceList.ProductList.tax')"
                            />
                            <small class="text-danger">{{ errors[0] }}</small>
                        </validation-provider>
                    </b-form-group>
                    <b-form-group>
                        <label for="amount">{{ $t('ReturnedSalesInvoiceList.ProductList.amount') }}</label>
                        <b-form-input
                            id="amount"
                            type="number"
                            ...
                            min="0"
                            autocomplete="off"
                            :placeholder="$t('ReturnedSalesInvoiceList.ProductList.amount')"
                        />
                    </b-form-group>
                    <b-form-group id="untaxedLocalCurrency">
                        <label for="untaxedLocalCurrency">{{ $t('ReturnedSalesInvoiceList.ProductList.untaxedLocalCurrency') }}</label>
                        <validation-provider
                            #default="{ errors }"
                        ...
                        >
                            <b-form-input
                                ...
                                min="0"
                                :state="errors.length > 0 ? false:null"
                                :placeholder="$t('ReturnedSalesInvoiceList.ProductList.untaxedLocalCurrency')"
                            />
                            <small class="text-danger">{{ errors[0] }}</small>
                        </validation-provider>
                    </b-form-group>
                    <b-form-group id="localCurrencyTax">
                        <label for="localCurrencyTax">{{ $t('ReturnedSalesInvoiceList.ProductList.localCurrencyTax') }}</label>
                        <validation-provider
                            #default="{ errors }"
                        ...
                        >
                            <b-form-input
                                ...
                                min="0"
                                :state="errors.length > 0 ? false:null"
                                :placeholder="$t('ReturnedSalesInvoiceList.ProductList.localCurrencyTax')"
                            />
                            <small class="text-danger">{{ errors[0] }}</small>
                        </validation-provider>
                    </b-form-group>
                    <b-form-group id="amountInLocalCurrency">
                        <label for="amountInLocalCurrency">{{ $t('ReturnedSalesInvoiceList.ProductList.amountInLocalCurrency') }}</label>
                        <validation-provider
                            #default="{ errors }"
                        ...
                        >
                            <b-form-input
                                ...
                                min="0"
                                :state="errors.length > 0 ? false:null"
                                :placeholder="$t('ReturnedSalesInvoiceList.ProductList.amountInLocalCurrency')"
                            />
                            <small class="text-danger">{{ errors[0] }}</small>
                        </validation-provider>
                    </b-form-group>
...
export default {
    ...
    data() {
        return {
            ...
            originalSalesNoOption: ['A123', 'B123', 'C123'],
    ...
    methods: {
        ...
        createMethod() {
            ...
            .then(() => {
                this.$toast({
                    ...
                    icon: 'CoffeeIcon',
                    variant: 'success',
                    text: `${this.$t('Returned Sales Invoice')} ${this.$t('createdSuccess')}!`,
                    },
                })
                this.$router.push({name:'SalesOperation-ReturnedSalesInvoiceList'});
            })
            .catch(error => {
                this.$toast({
                    component: ToastificationContent,
        ...
        editMethod() {
            ...
            .then(response => {
                let returnedSalesInvoice = response.data
                returnedSalesInvoice.products = returnedSalesInvoice.products.map(item => ({
                    ...item,
                    // stock: item.pivot.stock,
                    // safety_stock: item.pivot.safety_stock,
                }))

                this.showData = JSON.parse(JSON.stringify(returnedSalesInvoice));
                this.rows = JSON.parse(JSON.stringify(returnedSalesInvoice.products));
            })
        ...
        updateMethod() {
            ...
            .then(() => {
                this.$toast({
                    ...
                    icon: 'CoffeeIcon',
                    variant: 'success',
                    text: `${this.$t('Returned Sales Invoice')} ${this.$t('updatedSuccess')}!`,
                    },
                })
                this.$router.push({name:'SalesOperation-ReturnedSalesInvoiceList'});
            })
